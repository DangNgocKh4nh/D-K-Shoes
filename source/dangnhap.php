...
if (isset($_SESSION['username']) && $_SESSION['username']) {
    ...
    echo '<a href="/D&KShoes/source/index.php">Click để quay về trang chủ</a>';
} else {
    // Xử lý đăng nhập
    if (isset($_POST['dangnhap'])) {
        ...
        $sql = "SELECT TenDangNhap, MatKhau FROM taikhoan WHERE TenDangNhap='$username' and Xoa = 0";
...
<div id="vien">
    <div class="center">
        <div id="ban">
            <a id="ba" href="/D&KShoes/source/index.php">Trang chủ</a> > <font color="#008744">Đăng nhập tài khoản</font>
        </div>
    </div>
</div>
<div id="vien">
    <div class="center">
        ...
        <div id="ban">
            <form action='/D&KShoes/source/dangnhap.php?do=login' method='POST'>
                <p>Tên đăng nhập </p>
