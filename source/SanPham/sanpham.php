...
if (isset($_GET["id"])) {
    ...
    if(isset($_SESSION[$sessionKey])) {
        ...
        $s = "UPDATE sanpham SET SoLuotXem = SoLuotXem + 1 WHERE MaLoaiSanPham = '$id'";
    ...
    echo '<br/><br/><br/><a class="submit3" href="../giohang/index.php?mod=them&item='.$row['MaSanPham'].'">Thêm vào giỏ hàng</a>';
    echo'</p>';
    echo'</td></tr></table>';
    echo'</div>';
    ...
    while($show = mysqli_fetch_array($tvspcl))
    {
        ...
        $hinh = $show['HinhURL'];
        echo'<div class="list2"><a href="/D&KShoes/source/SanPham/index.php?mod=sanpham&id='.$id.'">
        <img src="../images/'.$hinh.'" width="215px" height="200px"></a>';
        echo '<a id="tensp" href="/D&KShoes/source/SanPham/index.php?mod=sanpham&id='.$id.'"><p>'.$name.'</p></a>';
