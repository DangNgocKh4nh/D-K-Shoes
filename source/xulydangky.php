...
if(isset($_POST['dangky'])) {
    ...
    if (mysqli_num_rows($result) > 0)
    {
        ...
        echo '<script language="javascript">alert("Tên đăng nhập đã tồn tại"); window.location="D&KShoes/source/dangky.php";</script>';
    ...
    {
        // Sử dụng javascript để thông báo
        echo '<script language="javascript">alert("Email đã tồn tại"); window.location="D&KShoes/source/dangky.php";</script>';
    ...
    {
        // Sử dụng javascript để thông báo
        echo '<script language="javascript">alert("Số điện thoại đã tồn tại"); window.location="D&KShoes/source/dangky.php";</script>';
...
if($result) {
    ...
    echo '<a href="/D&KShoes/source/index.php"><button class="button">Về trang chủ</button></a></div></div></div>';
