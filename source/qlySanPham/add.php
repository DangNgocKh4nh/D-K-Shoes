...
if (isset($_POST['themsp'])) {
    ...
    if (mysqli_query($connection, $sql)) {
        echo "<div class='list'>Thêm sản phẩm thành công. <a href='/D&KShoes/source/qlySanPham'>Quay lại</a></div>";
        exit;
    } else {
...
<div class="list">
    <form action='/D&KShoes/source/qlySanPham/index.php?mod=add' method='POST' enctype="multipart/form-data">
        <table>
            <tr>
                <td>
                    <p>Tên sản phẩm </p>
