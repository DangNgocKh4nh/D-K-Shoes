...
if (isset($_GET["id"])) {
    ...
    if (mysqli_query($connection, $sql)) {
        echo "<div class='list'>Sửa tên thương hiệu thành công. <a href='/D&KShoes/source/qlyHangSX/index.php?mod=panel'>Quay lại</a></div>";
        exit;
    } else {
...
<div class="list">
<?php
echo '<form action="/D&KShoes/source/qlyHangSX/index.php?mod=update&id='.$id.'" method="POST" >';
?>
    <p>Tên thương hiệu</p>
    <?php
