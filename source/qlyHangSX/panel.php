...
// 2. Tạo câu truy vấn (Query): SELECT, INSERT, DELETE, UPDATE
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        echo''.$id.'. '.$name.'';
        echo '<div class="tool"><a href="/D&KShoes/source/qlyHangSX/index.php?mod=update&id='.$id.'"><i class="far fa-edit"></i></a>  ';
        if($xoa == 1) {
            echo '<a href="/D&KShoes/source/qlyHangSX/index.php?mod=restore&id='.$id.'"><i class="fas fa-trash-restore-alt"></i></a>';
        } else {
            echo '<a href="/D&KShoes/source/qlyHangSX/index.php?mod=del&id='.$id.'"><i class="far fa-trash-alt"></i></a>';
        }
        echo '</div></div>';
    }
?>
